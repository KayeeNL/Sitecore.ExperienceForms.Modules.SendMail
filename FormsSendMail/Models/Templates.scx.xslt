...
namespace DynamicPlaceholderGrids.Models
{
  ...
  public partial class <xsl:value-of select="@classname"/> : CustomItem
  {
    ...
    public static class FieldNames {
      <xsl:apply-templates select="section/field" mode="FieldNames" />
    }
...
<xsl:template match="field" mode="FieldNames">
      public static readonly string <xsl:value-of select="@propertyname"/> = "<xsl:value-of select="@name"/>";
</xsl:template>
